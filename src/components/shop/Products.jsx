    ...
    <div className="mt-15 mb-15">
      <div className="flex flex-wrap justify-around w-[80%] gap-5 m-auto mt-5 ">
        {products.map((product) => {
          return (
            <div className="w-[21%] bg-[#F4F5F7] group relative overflow-hidden">
              ...
              <div className="p-3">
                ...
                {product.discount ? (
                  <span className="bg-[#E97171] rounded-full w-10 h-10 text-[15px] flex items-center justify-center absolute top-2 right-3">
                    -{product.discount}%
                  </span>
                ) : product.newItem ? (
                  <span className="bg-[#2EC1AC] rounded-full w-10 h-10 text-[14px] flex items-center justify-center absolute top-2 right-3">
                    {product.newItem}
                  </span>
                ) : null}
                ...
                <div className="absolute w-full h-full bg-black/60 flex items-center justify-center -bottom-0 -right-0 group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <NavLink to={`product-details/${product.id}`}>
                    <button className="bg-amber-50 text-[#B88E2F] text-[15px] py-3 px-10 cursor-pointer hover:bg-[#B88E2F] hover:text-white">
                      Add to Cart
                    </button>
                  </NavLink>
                  <div>
      ...
      <div className="flex justify-center items-center mt-15 gap-10 ">
        <p className="bg-[#B88E2F] px-5 py-3 cursor-pointer rounded-lg text-white">1</p>
        <p className="bg-[#F9F1E7] px-5 py-3 cursor-pointer rounded-lg">2</p>
        <p className="bg-[#F9F1E7] px-5 py-3 cursor-pointer rounded-lg">3</p>
        <p className="bg-[#F9F1E7] px-5 py-3 cursor-pointer rounded-lg">Next</p>
      </div>
    </div>
  );
}
